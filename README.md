# 📚 Relatório de Atividades – Desenvolvimento Web
...
Foi realizada a integração do projeto com Git e GitHub, incluindo criação de repositório, commit e push. Também foi feito o versionamento do projeto diretamente pelo Eclipse.

---

## ✅ CONCLUSÃO
As atividades foram concluídas com sucesso, permitindo a aplicação prática dos conceitos de desenvolvimento web com JSF, configuração de ambiente no Eclipse com WildFly e utilização de controle de versão com Git e GitHub.

Todos os arquivos, códigos e estrutura do projeto estão disponíveis neste repositório.
